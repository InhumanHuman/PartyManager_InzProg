    ...
    public int checkCredentials(Label errorMessage, String login, String password, ActionEvent actionEvent){
        try {
            ...
            try {
                ...
                psCheckUserExists = connection.prepareStatement("SELECT * FROM uzytkownicy WHERE login = ? AND haslo = ?");
